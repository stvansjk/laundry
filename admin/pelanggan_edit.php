...
pelanggan where pelanggan_id='$id'");
                while ($d = mysqli_fetch_array($data)) {
                ?>
                    <form method="post" action="pelanggan_update.php">
                        <div class="form-group">
                            <label>Nama</label>
                            <!-- form id pelanggan yang di
edit, untuk di kirim ke file aksi -->
                        ...
                        <div class="form-group">
                            <label>HP</label>
                            <input type="number" class="formcontrol" name="hp" placeholder="Masukkan no.hp .." value="<?php echo
                                                                                                                        $d['pelanggan_hp']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
