...
<head>
    <title>Sistem Informasi Laundry Smart Tech
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            ?>
                ...
                <a href="transaksi_invoice_cetak.php?id=<?php echo
                                                        $id; ?>" target="_blank" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-print"></i> CETAK</a>
