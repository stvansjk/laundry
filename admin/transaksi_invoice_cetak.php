...
<head>
    <title>Sistem Informasi Laundry Smart Tech Academy - WWW.smarttechacademy.COM</title>
...
<body>
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            ...
            $id = $_GET['id'];
            // megambil data pelanggan yang ber id di atas dari tabel
            ...
            ?>
                <center>
                    <h2>LAUNDRY " Smart Tech Academy "</h2>
                </center>
                ...
                <p>
                    <center><i>" Terima kasih telah mempercayakan
                            cucian anda pada kami ".</i></center>
                </p>
